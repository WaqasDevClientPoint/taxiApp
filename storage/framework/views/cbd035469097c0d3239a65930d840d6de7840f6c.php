      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo Form::open(['url' => 'admin/add-cancel-reason', 'class' => 'form-horizontal']); ?>
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::select('cancelled_by', array('Rider' => 'Rider', 'Driver' => 'Driver', 'Admin' => 'Admin', 'Company' => 'Company'), '', ['class' => 'form-control', 'id' => 'input_cancelled_by', 'placeholder' => 'Select']); ?>
        ...
        <div class="panel" ng-init="translations = <?php echo e(json_encode(old('translations') ?: array())); ?>;removed_translations =  [];  errors = <?php echo e(json_encode($errors->getMessages())); ?>;" ng-cloak>
              ...
              <div class="box-footer text-center">
                ...
                <a href="<?php echo e(url(LOGIN_USER_TYPE.'/cancel-reason')); ?>" class="btn btn-default">Cancel</a>
              </div>
              <!-- /.box-footer -->
            <?php echo Form::close(); ?>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pooltechnology/web/pool.ronelssolutions.co.ke/public_html/resources/views/admin/cancel_reason/add.blade.php ENDPATH**/ ?>