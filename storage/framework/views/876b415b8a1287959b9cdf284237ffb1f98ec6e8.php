                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <?php if(LOGIN_USER_TYPE=='corporate'): ?>
                                <div style="float:right;"><a class="btn btn-success" href="<?php echo e(url(LOGIN_USER_TYPE.'/add_group')); ?>">Add Group</a></div>
                            <?php endif; ?>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamp\htdocs\pool\taxiApp\resources\views/admin/group/view.blade.php ENDPATH**/ ?>