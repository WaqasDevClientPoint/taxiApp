...
<body ng-app="App" class="<?php echo e((!isset($exception)) ? (Route::current()->uri() == '/' ? 'homepage' : '') : ''); ?> commonpage"><?php /**PATH /home/pooltech/web/poolus.biz/public_html/resources/views/common/head.blade.php ENDPATH**/ ?>