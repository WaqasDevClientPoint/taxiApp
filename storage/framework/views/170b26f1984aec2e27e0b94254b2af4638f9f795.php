<?php $__env->startSection('main'); ?>
	...
	<?php
		if(strpos($result->vehicle_name, '-') !== false){
          $res=explode('-',$result->vehicle_name);
          $make_other = $res[0];
      $model_other = $res[1];
       }else{
      $res=explode(' ',$result->vehicle_name);
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					...
					<?php echo Form::hidden('driver_id', $result->user_id, ['id' => 'driver_id']); ?>

					<?php echo Form::hidden('user_country_id', @$result->user->country->id, ['id' => 'user_country_id']); ?>
					...
					<div class="box-body">
						...
						<div class="form-group">
			              ...
			              <div class="col-md-7 col-sm-offset-1">
			                <?php echo Form::select('vehicle_make_id',$make, $result->vehicle_make_id, ['class' => 'form-control',"onchange"=>"addOtherMake(this)",'id' => 'vehicle_make', 'placeholder' => 'Select']); ?>

			                <span class="text-danger"><?php echo e($errors->first('vehicle_make_id')); ?></span>
			              </div>
			            </div>
						<div class="form-group" id="other_make" style="<?php echo e(($result->vehicle_make_id!=0) ? 'display: none' : ''); ?>">
							<label for="vehicle_number" class="col-sm-3 control-label"><em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::text("other_make",$make_other, ['class' => 'form-control', 'id' => 'other_vehicle_make', 'placeholder' => 'Add vehicle make']); ?>
			            ...
			            <div class="form-group">
			              ...
			              <div class="col-md-7 col-sm-offset-1" ng-init='vehicle_model_id="<?php echo e($result->vehicle_model_id); ?>";'>
			                ...
			                <?php echo Form::select('vehicle_model_id', $model, $result->vehicle_model_id, ['class'=>'form-control',"onchange"=>"addOtherModel(this)", 'id'=>'vehicle_model', 'placeholder'=>'Select']); ?>

			                <span class="text-danger"><?php echo e($errors->first('vehicle_make_id')); ?></span>
			              </div>
			            </div>
						<div class="form-group" id="other_model" style="<?php echo e(($result->vehicle_model_id!=0) ? 'display: none' : ''); ?>">
							<label for="vehicle_number" class="col-sm-3 control-label"><em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::text("other_model",$model_other, ['class' => 'form-control', 'id' => 'other_vehicle_model', 'placeholder' => 'Add vehicle make']); ?>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamp\htdocs\taxiApp\resources\views/admin/vehicle/edit.blade.php ENDPATH**/ ?>