...
<div id="app-wrapper" class="signup-riders" >
    ...
    <div class="stage" style="margin-top: 10px;">
      <section class="signup-top">
        <div class="signup-top-text">
          <h2 class="text-center m-b-12"><?php echo e(trans('messages.footer.siginup_corporate')); ?></h2>
      ...
      <div class="form-wrapper text_frm">
        <?php echo e(Form::open(array('url' => 'corporate_register','id'=>"form"))); ?>
        ...
        <div class="input-group icon-input right cls_select">
          <div class="layout layout--flush col-md-12 container-field clearfix push-small--bottom">
            <div class="field ">
              <?php echo Form::text('company_name', @$user['company_name'], ['class' => ' form-control one-column-form__input--text','placeholder' => trans('messages.user.companyname'),'id' => 'company_name' ]); ?>


            </div>
            <span class="text-danger gender_error"><?php echo e($errors->first('company_name')); ?></span>
          </div>
        </div>
...
<?php echo $__env->make('templatesign', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamp\htdocs\taxiApp\resources\views/corporate/signup_corporate.blade.php ENDPATH**/ ?>