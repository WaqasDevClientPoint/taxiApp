          ...
          <div class="box">
            <div class="box-header">
              ...
              <?php if(LOGIN_USER_TYPE!='company' || Auth::guard('company')->user()->status == 'Active'): ?>
                <div style="float:right;"><a class="btn btn-success" href="<?php echo e(url(LOGIN_USER_TYPE.'/add_vehicle/'.$driver_id)); ?>">Add Vehicles </a></div>
              <?php endif; ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamp\htdocs\taxiApp\resources\views/admin/vehicle/view.blade.php ENDPATH**/ ?>