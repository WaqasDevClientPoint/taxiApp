...
<div class="cls_signin">
  <div class="container">
    ...
    <div class="col-lg-12" style="margin-top: 10px">
      <div class="col-lg-4">
        <div class="cls_signintext">
          <h4 ><?php echo e(trans('messages.home.corporate')); ?></h4>
          <p ><?php echo e(trans('messages.home.corporate_history')); ?></p>
          <a href="<?php echo e(url('signup_corporate')); ?>"><?php echo e(trans('messages.home.corporate_signup')); ?> <img src="images/new/arrow-right.svg" alt="arrow">
          </a>
        </div>
      </div>
...
<?php echo $__env->make('templatesign', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamp\htdocs\pool\taxiApp\resources\views/user/signup.blade.php ENDPATH**/ ?>