            ...
            <?php echo Form::open(['url' => 'admin/add_document', 'class' => 'form-horizontal']); ?>
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
               <div class="form-group">
                ...
                <div class="form-group">
                  <label for="input_status" class="col-sm-3 control-label">Required<em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::select('required', array('mandatory' => 'Mandatory', 'optional' => 'Optional'), $result->required ?? '', ['class' => 'form-control', 'id' => 'required']); ?>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamp\htdocs\taxiApp\resources\views/admin/documents/add.blade.php ENDPATH**/ ?>