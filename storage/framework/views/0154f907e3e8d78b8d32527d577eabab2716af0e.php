...
<aside class="main-sidebar">
	<section class="sidebar">
		<a href="<?php echo e(url(LOGIN_USER_TYPE.'/dashboard')); ?>" class="logo">
	      <img src="<?php echo e(url('admin_assets/dist/img/pool-Logo.png')); ?>" alt="logo">
	    </a>
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview <?php echo e((Route::current()->uri() == 'admin/admin_user' || Route::current()->uri() == 'admin/roles') ? 'active' : ''); ?>">
				<a href="#">
					<i class="fa fa-user-plus"></i> <span>Manage Admins</span> <i class="fa fa-angle-left pull-right"></i>
				</a>
			...
			<li class="<?php echo e((Route::current()->uri() == 'admin/company') ? 'active' : ''); ?>"><a href="<?php echo e(url('admin/company')); ?>"><i class="fa fa-building"></i><span>Manage Franchise</span></a></li>
			<?php endif; ?>
			...
			<li class="treeview <?php echo e((Route::current()->uri() == 'admin/vehicle_type' || Route::current()->uri() == $first_segment.'/vehicle') ? 'active' : ''); ?>">
				...
				<ul class="treeview-menu">
					...
					<li class="<?php echo e((Route::current()->uri() == 'admin/vehicle_type') ? 'active' : ''); ?>"><a href="<?php echo e(url('admin/vehicle_type')); ?>"><i class="fa fa-car"></i><span>Vehicle Types</span></a></li>
					<?php endif; ?>
				</ul>
			</li>
			<?php endif; ?>
			...
			<li class="treeview <?php echo e((Route::current()->uri() == 'admin/payout/overall' || Route::current()->uri() == 'admin/payout/company/overall' || Route::current()->uri() == 'company/payout/overall') ? 'active' : ''); ?>">
				...
				<ul class="treeview-menu">
					...
					<li class="<?php echo e((Route::current()->uri() == 'admin/payout/company/overall') ? 'active' : ''); ?>"><a href="<?php echo e(url('admin/payout/company/overall')); ?>"><i class="fa fa-circle-o"></i><span>Franchise Payouts</span></a></li>
					<?php endif; ?>
			...
			<?php if(@$user->can('manage_site_settings')): ?>
				<li class="treeview <?php echo e((Route::current()->uri() == 'admin/site_setting') ? 'active' : ''); ?>">
					<a href="#">
...
<?php /**PATH /home/pooltechnology/web/pool.ronelssolutions.co.ke/public_html/resources/views/admin/common/navigation.blade.php ENDPATH**/ ?>