		...
		<div class="height--full separated--sides pull-left full-width">
			<div style="padding:0px;" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 flexbox__item one-fifth page-sidebar hidden--portable hide-sm-760">
				<ul class="site-nav">
					...
					<li>
						<a href="<?php echo e(route('rides')); ?>" aria-selected="<?php echo e((Route::current()->uri() == 'rides') ? 'true' : 'false'); ?>" class="side-nav-a">Rides</a>
					</li>
					<li>
						<a href="<?php echo e(route('group')); ?>" aria-selected="<?php echo e((Route::current()->uri() == 'profile') ? 'true' : 'false'); ?>" class="side-nav-a">Groups</a>
					</li>
					<li>
						<a href="#" aria-selected="<?php echo e((Route::current()->uri() == 'profile') ? 'true' : 'false'); ?>" class="side-nav-a">Policies</a>
					</li>
					<li>
						<a href="#" aria-selected="<?php echo e((Route::current()->uri() == 'profile') ? 'true' : 'false'); ?>" class="side-nav-a">People</a>
					</li>
					<li>
						<a href="#" aria-selected="<?php echo e((Route::current()->uri() == 'profile') ? 'true' : 'false'); ?>" class="side-nav-a">Ride Booker</a>
					</li>
					<li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xamp\htdocs\pool\taxiApp\resources\views/common/dashboard_side_menu_corporate.blade.php ENDPATH**/ ?>