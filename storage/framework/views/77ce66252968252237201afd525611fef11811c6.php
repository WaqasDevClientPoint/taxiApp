<?php $__env->startSection('main'); ?>
  ...
  <div class=" text--left signupdrive">
            ...
            <div class="col-lg-12 pad-0">
              ...
              <div class="col-lg-5 pad-0">
                <div class="driverform">
                  <?php echo e(Form::open(array('url' => 'corporate_register','class' => 'layout layout--flush driver-signup-form-join-legacy','id'=>'form'))); ?>
                  ...
                  <div class="col-lg-12">
                    ...
                    <button name="step" value="basics" class="btn btn--primary" id="submit-btn"  type="submit"  style="width: 100%;"  ><?php echo e(trans('messages.user.submit')); ?>
...
<?php echo $__env->make('template_footeronly', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamp\htdocs\pool\taxiApp\resources\views/corporate/signup_corporate.blade.php ENDPATH**/ ?>