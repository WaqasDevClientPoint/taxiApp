      ...
      <div class="row">
        ...
        <div class="col-md-12" >
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              <?php echo Form::open(['url' => 'admin/add_help_category', 'class' => 'form-horizontal']); ?>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pooltechnology/web/pool.ronelssolutions.co.ke/public_html/resources/views/admin/help_category/add.blade.php ENDPATH**/ ?>