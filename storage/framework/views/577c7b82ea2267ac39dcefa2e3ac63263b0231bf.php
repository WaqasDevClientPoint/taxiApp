  ...
  <div class="container">
    ...
    <div class="col-lg-12" style="margin-top: 10px">
      <?php if(Auth::user()==null): ?>
        <div class="col-lg-4">
          <div class="cls_signintext">
            <h4 ><?php echo e(trans('messages.profile.corporate')); ?></h4>
            <p ><?php echo e(trans('messages.profile.track_every')); ?></p>
            <a href="<?php echo e(url('signin_corporate')); ?>"><?php echo e(trans('messages.profile.corporate_signin')); ?> <img src="images/new/arrow-right.svg" alt="arrow">
            </a>
          </div>
        </div>
      <?php endif; ?>
...
<?php echo $__env->make('templatesign', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamp\htdocs\pool\taxiApp\resources\views/user/signin.blade.php ENDPATH**/ ?>