		...
		<div class="height--full separated--sides pull-left full-width">
			<div style="padding:0px;" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 flexbox__item one-fifth page-sidebar hidden--portable hide-sm-760">
				<ul class="site-nav">
					...
					<li>
						<a href="#" aria-selected="<?php echo e((Route::current()->uri() == 'profile') ? 'true' : 'false'); ?>" class="side-nav-a">Groups</a>
					</li>
					<li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xamp\htdocs\taxiApp\resources\views/common/dashboard_side_menu_corporate.blade.php ENDPATH**/ ?>