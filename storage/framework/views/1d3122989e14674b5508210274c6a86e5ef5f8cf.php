    ...
    <div class="soft-tiny" data-reactid="11">
      <div data-reactid="12">
        <form class="push--top-small forward" method="POST" data-reactid="13">
          <input type="hidden" name="user_type" value="Corporate" id="user_type">
      ...
      <div class="small push-small--bottom push-small--top" id="sign-up-link-only" data-reactid="26">
        <p class=" display--inline email_phone-sec" data-reactid="27"><?php echo e(trans('messages.user.no_account')); ?><a href="<?php echo e(url('signup_corporate')); ?>"><?php echo e(trans('messages.home.siginup')); ?></a></p>
        <p class="forgot password-sec hide">
          <a href="<?php echo e(url('forgot_password_corprate')); ?>" class="forgot-password"><?php echo e(trans('messages.user.forgot_paswrd')); ?></a>
        </p>
      </div>
    </div>
  </div>
...
<?php echo $__env->make('templatesign', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\taxiApp\resources\views/user/signin_corporate.blade.php ENDPATH**/ ?>