...
//		$vehicles->vehicle_model_id = $request->model_id;
        ...
        if($request->model_id!=0 && $request->make_id!=0){
        ...
        }elseif ($request->model_id==0 && $request->make_id!=0){

            $make_name = MakeVehicle::whereId($request->make_id)->value('make_vehicle_name');
            $vehicles->vehicle_make_id   = $request->make_id;
            $vehicles->vehicle_model_id  = 0;
            $vehicles->vehicle_name      = $make_name.' - '.$request->model_name;

        }else{

            $vehicles->vehicle_make_id   = 0;
            $vehicles->vehicle_model_id  = 0;
            $vehicles->vehicle_name      = $request->make_name.' - '.$request->model_name;
        }
