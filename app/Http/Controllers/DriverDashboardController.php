...
//    dd($request->all());
        ...
        if($request->vehicle_make_id==0){
            $rules['other_vehicle_make'] = 'required|unique:vehicle_make,make_vehicle_name';
        }

        if($request->vehicle_model_id==0){
            $rules['other_vehicle_model'] = 'required|unique:vehicle_model,model_name';
        }
       ...
       ;
        ...
        if($request->vehicle_model_id!=0 && $request->vehicle_make_id!=0){
            ...
            $vehicle->vehicle_name      = $make_name.' - '.$request->other_vehicle_model;
        }else{
            $vehicle->vehicle_make_id   = 0;
            $vehicle->vehicle_model_id  = 0;
            $vehicle->vehicle_name      = $request->other_vehicle_make.' - '.$request->other_vehicle_model;
        }
