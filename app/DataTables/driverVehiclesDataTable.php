...
class driverVehiclesDataTable extends DataTable
{
    /**
...
//        return datatables()
//            ->eloquent($query)
//            ->addColumn('action', 'drivervehicles.action');
        return datatables()
            ->of($query)
     ...
     *
     * @param \App\Models\driverVehicle $model
