...
class DriverDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('email', function ($users) {
            ...
            ->addColumn('manageVehicle', function($users) {
                return '<a class="btn btn-info" href="/admin/vehicle/driver/'.$users->id.'">Manage Vehicle</a>';
            })
        ->addColumn('action', function ($users) {
            ...
            return $edit.$delete;
        })            ->rawColumns(['manageVehicle','action']);
    }
    ...
    protected function getColumns()
    {
        ...
        $more_columns = [
            ...
            ['data' => 'manageVehicle', 'name' => 'users.id', 'title' => 'Manage Vehicle'],
