...
Route::group(['middleware' =>'locale'], function () {
    ...
    Route::match(array('GET', 'POST'), 'signin_corporate', 'UserController@signin_corporate');
    ...
    Route::match(array('GET', 'POST'),'signup_corporate', 'UserController@signup_corporate');
    ...
    Route::post('corporate_register', 'UserController@corporate_register');
