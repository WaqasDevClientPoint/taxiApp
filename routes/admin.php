...
Route::group(['prefix' => (LOGIN_USER_TYPE=='company')?'company':'admin', 'middleware' =>'admin_guest'], function () {
	...
	Route::group(['middleware' =>  'admin_can:manage_vehicle'], function() {
		Route::get('vehicle/driver/{id}', 'VehicleController@index');
        Route::get('manage_vehicles', 'VehicleController@getDriverVehicle');
        Route::get('add_vehicle/{id}', 'VehicleController@add');
        Route::post('add_vehicle', 'VehicleController@add');
...
//        Route::match(array('GET', 'POST'), 'add_vehicle', 'VehicleController@add');
    ...
    Route::post('getMakeList','VehicleModelController@getMakeList');
...
Route::group(['prefix' => (LOGIN_USER_TYPE=='corporate')?'corporate':'admin', 'middleware' =>'admin_guest'], function () {
    ...
    //Manage Corporate
    Route::get('group', 'GroupController@index')->middleware('admin_can:view_group');
    Route::match(array('GET', 'POST'), 'add_group', 'GroupController@add')->middleware('admin_can:create_group');
