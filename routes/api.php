...
Route::group(['middleware' => 'jwt.verify'], function () {
    ...
    Route::get('delete_account', 'RiderController@delete_account');
    ...
    Route::post('start_trip', 'TripController@startTrip');
    Route::post('add_ringtone', 'TripController@addRingtone');
    ...
    Route::post('instant_ride', 'TripController@instantRide');
