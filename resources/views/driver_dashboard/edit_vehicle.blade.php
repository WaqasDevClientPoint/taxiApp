	...
	<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0 0px 15px;">
		...
		<div class="col-lg-12 form-group">
			 ...
			 <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
				{!! Form::select('vehicle_make_id',$make, $result->vehicle_make_id, ['class' => 'form-control',"onchange"=>"addOtherMake(this)", 'id' => 'vehicle_make', 'placeholder' => trans('messages.driver_dashboard.select') ]) !!}
				<span class="text-danger">{{ $errors->first('vehicle_make_id') }}</span>
			</div>
		</div>
		<div class="col-lg-12 form-group" style="{{($result->vehicle_make_id!=0) ? 'display: none' : ''}}" id="other_make">
			<label class="col-lg-4 col-md-4 col-sm-4 col-xs-6"
				   style="padding:6px 0px;"></label>
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
				{!! Form::text('other_vehicle_make',$make_other, ['class' => 'form-control', 'id' => 'other_vehicle_make']) !!}
		...
		<div class="col-lg-12 form-group vehicle_model">
			 ...
			 <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
				{!! Form::select('vehicle_model_id',$model, $result->vehicle_model_id, ['class' => 'form-control',"onchange"=>"addOtherModel(this)", 'id' => 'vehicle_model', 'placeholder' => trans('messages.driver_dashboard.select') ]) !!}
				<span class="text-danger">{{ $errors->first('vehicle_model_id') }}</span>
			</div>
		</div>
		<div class="col-lg-12 form-group" style="{{($result->vehicle_model_id!=0) ? 'display: none' : ''}}" id="other_model">
			<label class="col-lg-4 col-md-4 col-sm-4 col-xs-6"
				   style="padding:6px 0px;"></label>
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
				{!! Form::text('other_vehicle_model',$model_other, ['class' => 'form-control', 'id' => 'other_vehicle_model']) !!}
