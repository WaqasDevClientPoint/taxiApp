  ...
  <div class="container">
    ...
    <div class="col-lg-12" style="margin-top: 10px">
      @if(Auth::user()==null)
        <div class="col-lg-4">
          <div class="cls_signintext">
            <h4 >{{trans('messages.profile.corporate')}}</h4>
            <p >{{trans('messages.profile.track_every')}}</p>
            <a href="{{ url('signin_corporate') }}">{{trans('messages.profile.corporate_signin')}} <img src="images/new/arrow-right.svg" alt="arrow">
            </a>
          </div>
        </div>
      @endif
