		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					...
					{!! Form::hidden('driver_id', $result->user_id, ['id' => 'driver_id']) !!}
					{!! Form::hidden('user_country_id', @$result->user->country->id, ['id' => 'user_country_id']) !!}
					...
					<div class="box-body">
						...
						<div class="form-group">
			              ...
			              <div class="col-md-7 col-sm-offset-1">
			                {!! Form::select('vehicle_make_id',$make, $result->vehicle_make_id, ['class' => 'form-control',"onchange"=>"addOtherMake(this)",'id' => 'vehicle_make', 'placeholder' => 'Select']) !!}
			                <span class="text-danger">{{ $errors->first('vehicle_make_id') }}</span>
			              </div>
			            </div>
						<div class="form-group" id="other_make" style="{{($result->vehicle_make_id!=0) ? 'display: none' : ''}}">
							<label for="vehicle_number" class="col-sm-3 control-label"><em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::text("other_make",$make_other, ['class' => 'form-control', 'id' => 'other_vehicle_make', 'placeholder' => 'Add vehicle make']) !!}
			            ...
			            <div class="form-group">
			              ...
			              <div class="col-md-7 col-sm-offset-1" ng-init='vehicle_model_id="{{ $result->vehicle_model_id }}";'>
			                ...
			                {!! Form::select('vehicle_model_id', $model, $result->vehicle_model_id, ['class'=>'form-control',"onchange"=>"addOtherModel(this)", 'id'=>'vehicle_model', 'placeholder'=>'Select']) !!}
			                <span class="text-danger">{{ $errors->first('vehicle_make_id') }}</span>
			              </div>
			            </div>
						<div class="form-group" id="other_model" style="{{($result->vehicle_model_id!=0) ? 'display: none' : ''}}">
							<label for="vehicle_number" class="col-sm-3 control-label"><em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::text("other_model",$model_other, ['class' => 'form-control', 'id' => 'other_vehicle_model', 'placeholder' => 'Add vehicle make']) !!}
								<span class="text-danger">{{ $errors->first('other_make') }}</span>
							</div>
						</div>
