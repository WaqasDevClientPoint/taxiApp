    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ url(LOGIN_USER_TYPE.'/corporate') }}">Corporate</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Add Corporate Form</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        {!! Form::open(['url'=>'admin/add_corporate', 'class'=>'form-horizontal', 'files'=>true, 'id'=>'company_form']) !!}
                        <div class="box-body">
...
{{--                            </div>--}}
                            ...
                            <div class="box-footer text-center">
                                ...
                                <a href="{{url(LOGIN_USER_TYPE.'/corporate')}}"><span class="btn btn-default">Cancel</span></a>
                            </div>
                            <!-- /.box-footer -->
                            {!! Form::close() !!}
                        </div>
