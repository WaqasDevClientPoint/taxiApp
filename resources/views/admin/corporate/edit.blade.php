        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                @if(LOGIN_USER_TYPE == 'admin')
                    <li><a href="{{ url(LOGIN_USER_TYPE.'/corporates') }}">Corporates</a></li>
                @endif
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Corporate Form</h3>
                        </div>

                        {!! Form::open(['url'=>LOGIN_USER_TYPE.'/edit_corporate/'.$result->id, 'class'=>'form-horizontal', 'files'=>true, 'id'=>'company_form', 'novalidate']) !!}
