    ...
    <div class="content-wrapper" ng-controller="destination_admin">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ url(LOGIN_USER_TYPE.'/group') }}"> Groups </a></li>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-sm-offset-1">
                                    {!! Form::text('first_name', $result->name, ['class' => 'form-control', 'id' => 'input_first_name', 'placeholder' => 'Group Name']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-sm-offset-1">
                                    {!! Form::textarea('description', $result->description, ['class' => 'form-control', 'id' => 'input_description', 'placeholder' => 'Group Description']) !!}
