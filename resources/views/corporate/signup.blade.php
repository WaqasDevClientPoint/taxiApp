...
<div class="cls_signin">
  <div class="container">
    ...
    <div class="col-lg-12" style="margin-top: 10px">
      <div class="col-lg-4">
        <div class="cls_signintext">
          <h4 >{{trans('messages.home.corporate')}}</h4>
          <p >{{trans('messages.home.corporate_history')}}</p>
          <a href="{{ url('signup_corporate') }}">{{trans('messages.home.corporate_signup')}} <img src="images/new/arrow-right.svg" alt="arrow">
          </a>
        </div>
      </div>
